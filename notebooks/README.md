...
This should allow you to directly import `src/controlnet` in your notebook.
...
Run `python -m ipykernel install --user --name="controlnet"` from within your project environment to allow jupyter
to use your project's virtual environment. Afterwards a new kernel called controlnet should be available in the
